...
public class JuegoController extends BasePantallaController {
    ...
    public void upgrades() throws WizardTiredException {
        ...
        writeConsole("---------");
        boolean exitMenu = false; // variable para controlar la salida del menú
        while (!exitMenu) { // salir del bucle cuando exitMenu sea verdadero
            try {
                TextInputDialog dialog = new TextInputDialog();
                ...
                try {
                    switch (option.get()) {
                        case 0:
                            exitMenu = true; // si la opción es 0, salir del menú
                            break;
                        case 1:
                            homeManager.upgradeLifeMax();
                            break;
                        case 2:
                            homeManager.upgradeEnergyMax();
                            break;
                        case 3:
                            homeManager.upgradeComfort();
                            break;
                        case 4:
                            homeManager.upgradeSingaMax();
                            break;
                        default:
                            writeConsole("Select a correct option.");
                    }
